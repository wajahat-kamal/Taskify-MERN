        ...
        <section id="#cta" className="relative bg-transparent text-[#F0F4FF] overflow-hidden py-16 px-6">
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                <motion.div
                    ...
                    className="relative rounded-3xl overflow-hidden border border-primary/20 p-px"
                    style={{
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                            ...
                            <motion.p
                                ...
                                viewport={{ once: true }}
                                custom={0.3}
                                className="mt-4 text-lightprimary max-w-[420px] leading-[1.8] text-xs md:text-base"
                            >
                            ...
                            <motion.p
                                ...
                                viewport={{ once: true }}
                                custom={0.5}
                                className="mt-6 text-lightprimary text-sm"
                            >
