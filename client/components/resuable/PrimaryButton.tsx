...
function PrimaryButton({ text, route, widthFull }: { text: string, route: string, widthFull: boolean }) {
    ...
    return (
        <motion.button
            ...
            className={`relative cursor-pointer flex items-center justify-center gap-2 bg-primary text-white font-bold px-8 py-3.5 rounded-xl text-[15px] overflow-hidden group ${widthFull ? "w-full" : ""}`}
